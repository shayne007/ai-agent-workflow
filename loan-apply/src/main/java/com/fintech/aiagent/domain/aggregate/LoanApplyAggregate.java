...
package com.fintech.aiagent.domain.aggregate;

import com.fintech.aiagent.domain.entity.LoanApply;
import com.fintech.aiagent.domain.entity.CreditReport;
import com.fintech.aiagent.domain.entity.Document;
import com.fintech.aiagent.domain.valueobject.ApplicationId;
import com.fintech.aiagent.domain.valueobject.ApprovalDecision;
import com.fintech.aiagent.domain.valueobject.CreditScore;
import com.fintech.aiagent.domain.valueobject.RiskLevel;
 ...
 */
public class LoanApplyAggregate {
    
    private final LoanApply application;
     ...
     * 创建新的信贷申请
     */
    public LoanApplyAggregate(CustomerId customerId, String applicationType) {
        String applicationId = UUID.randomUUID().toString();
        this.application = new LoanApply(
     ...
     * 从现有申请重建聚合根
     */
    public LoanApplyAggregate(LoanApply application, CreditReport creditReport) {
     ...
     * 获取原始申请实体
     */
    public LoanApply getApplication() {
        return application;
    }
}