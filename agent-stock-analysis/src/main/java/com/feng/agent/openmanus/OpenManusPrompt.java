...
package com.feng.agent.openmanus;
...
public interface OpenManusPrompt {
	...
	String PLANNING_SYSTEM_PROMPT = """
			...
			### Tool usage
			You are given access to a planning tool, which can be used to generate and save a plan for the task given by the user. The tool will return a structured plan with steps in sequential.
			You must call a tool save a structured plan.
